...
\addplot[color=red, thick, smooth] coordinates {
    (0,14.2) (20,11.8) (40,8.4) (60,4.7) (80,2.1) (100,0.8)
};
\addlegendentry{Poacher Best Response}
\addplot[color=blue, dashed, thick] coordinates {
    (0,14.2) (100,14.2)
};
\addlegendentry{Baseline (No Adaptation)}
\end{axis}
\end{tikzpicture}
\caption{Adversarial response curve: Poaching incidents vs. ranger coverage}
\end{figure}
