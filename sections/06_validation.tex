...
\begin{itemize}
    \item \textbf{Area}: 1,334 km² (5.8$\times$ smaller than Etosha)
    \item \textbf{Flagship species}: Bengal tiger (Panthera tigris) -- $\sim$70 individuals
    \item \textbf{Threat profile}: Poaching for traditional medicine, habitat fragmentation from tourism
    \item \textbf{Protection achieved}: 87.2\% (vs. 62.8\% uniform baseline, +24.4 pp)
    \item \textbf{Key adaptation}: Smaller zone size (50 km² vs. 460 km²) due to higher tiger density
    \item \textbf{Staffing}: 42 rangers (3.1 rangers/100 km² vs. 0.88/100 km² at Etosha)
    \item \textbf{Challenge}: Tiger territories require continuous monitoring; tigers roam 20-30 km daily
\end{itemize}

\textbf{Implementation insight:} Higher ranger density is justified because tigers are wide-ranging compared to elephants, requiring more frequent patrol overlap to maintain deterrence.

\subsubsection{Pantanal Conservation Area, Brazil}

\begin{itemize}
    \item \textbf{Area}: 1,950 km²
    \item \textbf{Flagship species}: Jaguar (Panthera onca) -- $\sim$120 individuals
    \item \textbf{Threat profile}: Deforestation for cattle ranching, human-jaguar conflict
    \item \textbf{Protection achieved}: 84.6\% (vs. 59.3\% uniform baseline, +25.3 pp)
    \item \textbf{Key adaptation}: Flood season requires UAV-heavy monitoring (45\% UAV vs. 25\% at Etosha)
    \item \textbf{Seasonal constraint}: Wet season makes 60\% of area inaccessible by road; boats and UAVs essential
    \item \textbf{Budget}: \$840K annually (30\% lower than Etosha) due to lower personnel costs
\end{itemize}

\textbf{Implementation insight:} Amphibious environments require UAV-heavy monitoring strategies. The framework correctly reallocates budget from rangers to UAVs when accessibility is seasonal.

\subsubsection{Yellowstone National Park, USA}

\begin{itemize}
    \item \textbf{Area}: 8,983 km² (39\% of Etosha size)
    \item \textbf{Flagship species}: Gray wolf (Canis lupus) -- $\sim$100 individuals, grizzly bear (Ursus arctos)
    \item \textbf{Threat profile}: Tourism pressure (4M visitors/year), climate-induced habitat shifts, human-wildlife conflict
    \item \textbf{Protection achieved}: 92.8\% (vs. 71.4\% uniform baseline, +21.4 pp)
    \item \textbf{Key adaptation}: Tourism crowd-sourcing; visitors report sightings via app (equivalent to 500 additional observers)
    \item \textbf{Challenge}: High human density near popular sites (Old Faithful) requires different threat model
    \item \textbf{Budget}: \$2.8M annually (2.3$\times$ Etosha) due to higher salaries and technology investment
\end{itemize}

\textbf{Implementation insight:} High-budget reserves can achieve >90\% protection by combining professional rangers with citizen-science monitoring. The framework's modular design allows incorporating "volunteer observer" as a monitoring method.
