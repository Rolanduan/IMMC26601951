...
Table \ref{tab:model_comparison} summarizes model characteristics:
...
\begin{tabular}{lcccc}
\toprule
Model & Variables & Constraints & Objective & Solution \\
\midrule
Model 0 & Deterministic & Capacity, time & Minimize time & CPLEX/ALNS \\
Model 1 & Stochastic & + Reliability $\geq \alpha$ & Minimize expected time & Scenario decomp. \\
Model 2 & Two-stage & + Recourse & Minimize expected time & L-shaped \\
Model 3 & Multi-depot & + Clustering & Minimize time & Clustering+ALNS \\
\bottomrule
\end{tabular}
\end{table}
