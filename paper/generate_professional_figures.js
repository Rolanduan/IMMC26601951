...
const meta = {
  "fig01_system_architecture.png": { tag: "LIABILITY CONTRACT", accent: palette.indigo, title: "Etosha Ecological-Liability Contract", subtitle: "Liability diagnosis, portfolio design, and workload guarantees are linked in one operating loop" },
  "fig02_etosha_grid.png": { tag: "GIS LIABILITY GRID", accent: palette.sage, title: "Etosha Liability Lattice and Service Grid", subtitle: "The park is encoded as ecological cells, operational anchors, and station service geometry" },
  "fig03_risk_heatmap.png": { tag: "LIABILITY RIDGE", accent: palette.rust, title: "Ecological-Liability Landscape", subtitle: "The dominant pattern is a narrow liability ridge rather than a uniform field of concern" },
  "fig04_risk_decomposition.png": { tag: "LIABILITY STACK", accent: palette.gold, title: "Consequence, Intensity, Uncertainty, and Drag", subtitle: "Ecological liability is decomposed into biological consequence, latent pressure, information deficit, and service drag" },
  "fig05_patrol_routes.png": { tag: "PORTFOLIO ROUTES", accent: palette.indigo, title: "Patrol Templates in the Contract Portfolio", subtitle: "Repeatable route templates are chosen for liability reduction rather than broad visual coverage" },
  "fig06_allocation_dashboard.png": { tag: "RISK PORTFOLIO", accent: palette.clay, title: "Liability-Reduction Portfolio Ledger", subtitle: "Patrols, sentinels, and reserve windows are translated into mean-loss and tail-risk reduction" },
  "fig07_schedule_timeline.png": { tag: "SERVICE CALENDAR", accent: palette.teal, title: "Workload-Aware Daily Service Calendar", subtitle: "Patrol departures and reserve windows are timed against station volatility and contract cells" },
  "fig08_simulation_results.png": { tag: "PROTECTION TRACE", accent: palette.indigo, title: "Protection Trace Under the Contract Portfolio", subtitle: "Stabilization occurs once liability and overload risk are jointly reduced" },
  "fig09_robustness_distribution.png": { tag: "TAIL CONTROL", accent: palette.rust, title: "Liability Robustness Envelope", subtitle: "The new design is judged by both mean performance and the high-loss tail" },
  "fig10_sensitivity_panels.png": { tag: "TRADE-OFF FRONTIER", accent: palette.gold, title: "Structural Trade-Offs in Teams and Uptime", subtitle: "The decisive levers are crew depth, sentinel uptime, and revisit discipline" },
  "fig11_transferability_matrix.png": { tag: "MORPHOLOGY TRANSFER", accent: palette.plum, title: "Transfer by Liability Morphology", subtitle: "The framework transfers by liability shape, uncertainty structure, and station workload geometry" },
  "fig12_station_response_map.png": { tag: "SERVICE DRAG", accent: palette.sky, title: "Service Drag and Delay Exposure", subtitle: "Station geometry creates a measurable asymmetry in where the service covenant can be met" },
  "fig13_sensor_drone_map.png": { tag: "LAYERED PORTFOLIO", accent: palette.teal, title: "Sentinels, Patrol Templates, and Mobile Reserve", subtitle: "The field package combines contract-cell watch, route protection, and mobile uncertainty absorption" },
  "fig14_ranger_requirement_curve.png": { tag: "TEAM FLOOR", accent: palette.sage, title: "Crew-Depth Requirement Curve", subtitle: "The staffing floor is the point at which the workload envelope stops violating the service covenant" },
  "fig15_scenario_matrix.png": { tag: "STABILITY REGION", accent: palette.clay, title: "Stability Frontier in Manpower and Detection", subtitle: "Iso-protection contours reveal where the system remains inside the liability contract region" },
  "fig16_controller_architecture.png": { tag: "PORTFOLIO CORE", accent: palette.indigo, title: "Ambiguity-Aware Portfolio Architecture", subtitle: "The optimizer balances expected liability, tail risk, and contract compliance in one field package" },
  "fig17_feedback_architecture.png": { tag: "WORKLOAD LOOP", accent: palette.teal, title: "Reserve Replanning and Workload Feedback", subtitle: "Station load, reserve reassignment, and next-cycle updating form one service loop" },
};
